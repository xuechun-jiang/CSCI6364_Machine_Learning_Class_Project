...
for epoch in range(num_epochs):
    ...
    print(
        f"[EfficientNet-B0] Epoch [{epoch+1}/{num_epochs}] "
...
plt.savefig(
    os.path.join(IMAGE_DIR, "efficientnet_b0_accuracy.png"),
    dpi=300
)
plt.close()
...
plt.savefig(
    os.path.join(IMAGE_DIR, "efficientnet_b0_confusion_matrix.png"),
    dpi=300
)
plt.close()
